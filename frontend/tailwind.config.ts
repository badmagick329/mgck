...
module.exports = {
  ...
  theme: {
  	...
  	extend: {
  		boxShadow: {
  			'glow-primary-dg': '0 0 10px hsla(25, 95%, 53%, 1), 0 0 2px hsla(25, 95%, 53%, 1) inset',
  			'glow-primary-em': '0 0 10px hsla(190, 100%, 15.5%, 1), 0 0 2px hsla(190, 100%, 15.5%, 1) inset',
  			'glow-primary-kp': '0 0 10px hsla(220 ,100% ,15.5%, 1), 0 0 2px hsla(220 ,100% ,15.5%, 1) inset',
  			'glow-primary-gf': '0 0 10px hsla(10 ,100% ,80%, 1), 0 0 2px hsla(10 ,100% ,80%, 1) inset',
  			'glow-secondary-dg': '0 0 10px hsla(0, 0%, 10%, 1), 0 0 2px hsla(0, 0%, 10%, 1) inset'
  		},
  		colors: {
  		...
  		animation: {
  			...
  			testanimation: 'testanimation 4s cubic-bezier(0.2, 0.75, 0.2, 1) infinite'
  		}
  	}
  },
